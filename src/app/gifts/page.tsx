  ...
  return (
    <div className='w-full lg:w-1/3 p-4'>
      <div className='rounded-xl bg-background-dimmer p-8 h-full flex flex-col justify-between'>
        ...
        <motion.button
          className={`mt-4 select-disabled rounded-full max-w-max shadow-md ${
            canAfford 
    ...
    return (
      <div className="min-h-screen bg-background p-8">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6 text-center">
          <h1 className="text-2xl font-bold mb-4 text-primary-darker">Sign In Required</h1>
          <p className="mb-6 text-gray-600">Please sign in to view and purchase gift cards with your rewards points.</p>
          <Link href="/rewards" className="inline-block bg-primary text-white py-2 px-4 rounded hover:bg-primary-darker transition-colors">
            Go to Rewards
          </Link>
        </div>
      </div>
      ...
      <section className="bg-black text-background">
        <div className="min-h-[90vh] lg:max-h-[750px] w-screen lg:p-32 py-12 lg:gap-32 flex max-lg:flex-col items-center justify-center relative">
          ...
          >
            ...
            <motion.div
              className="mt-4 p-4 bg-background-dimmer rounded-lg"
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.6 }}
            >
              <p className="text-primary-darker font-bold">Your Points: {userPoints}</p>
              <p className="text-sm text-gray-600">Earn more points by scanning QR codes at our restaurants!</p>
            </motion.div>
          </motion.div>
