  ...
  const toggleInfo = (index: number) => {
    ...
    <>
      <div className="w-full mt-16">
        ...
        {/* Impact Estimate - positioned at the top right, above the preparation icon */}
        <div className="w-11/12 mx-auto mt-4">
          <div className="flex justify-end lg:pr-[2%]">
            <motion.div
        ...
        <div className="w-11/12 flex flex-row flex-wrap gap-4 mx-auto mt-4">
